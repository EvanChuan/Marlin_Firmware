...
// Sensorless probing requirements
  ...
  #elif !Z_SENSORLESS && !(I_SENSORLESS || J_SENSORLESS)  // EC: mentain
    #error "SENSORLESS_PROBING requires a TMC stepper driver with StallGuard on Z."
  #elif !(I_SENSORLESS || J_SENSORLESS)    // EC: add
    #error "SENSORLESS_PROBING requires a TMC stepper driver with StallGuard on I or J."
  #endif
#endif
